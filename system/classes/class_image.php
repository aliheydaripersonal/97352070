...
class image {
  ...
  public function __destruct() {
    if(1||$this->image !== null && get_resource_type($this->image) === 'gd') {
  ...
  public function imageCopyMerge($srcIm, $dstX, $dstY, $srcX, $srcY, $srcW, $srcH, $pct)
  {
	imagealphablending($this->image, false);
	imagesavealpha($this->image, true);
	imagecopymerge($this->image, $srcIm,$dstX, $dstY, $srcX, $srcY, $srcW, $srcH, $pct);
  }
  //////////////////////////////////////////////////////////////////////////////////////////////////
  // Manipulation
  //////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public function overlay($overlay, $anchor = 'center', $opacity = 1, $xOffset = 0, $yOffset = 0) {
    ...
    if(!($overlay instanceof SimpleImage)) {
	  ...
	  $overlay->resize(null,$this->getHeight());
    }
    // Convert opacity
